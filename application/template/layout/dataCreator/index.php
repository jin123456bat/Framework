	...
	<table border="1px">
		...
		<tbody>
			<tr data-a="main_overview_cds">
				...
				<td><input type="text" name="starttime" data-time="7"
					placeholder="开始时间"> <input type="text" name="endtime" data-time="7"
					placeholder="结束时间"> <select name="duration">
		...
		<tfoot align="center">
			<tr>
				<td>模式</td>
				<td colspan="3"><input class="mode" type="radio" name="mode"
					value="1">直线</td>
				<td colspan="4"><input type="radio" class="mode" name="mode"
					checked="checked" value="0">随机</td>
			</tr>
			<tr>
				<td colspan="4"><button id="build">开始生成</button></td>
				<td colspan="4"><button id="clean">清空所有数据</button></td>
			</tr>
		</tfoot>
	</table>
