...
class BaseComponent extends component
{
	...
	function getFloorTime($time,$duration)
	{
		switch ($duration)
		{
			case 300: return date('Y-m-d H:',strtotime($time)).(floor(date('i',strtotime($time))/5)*5).':00';
			case 1800: return date('Y-m-d H:',strtotime($time)).(floor(date('i',strtotime($time))/30)*30).':00';
			case 3600: return date('Y-m-d H:00:00',strtotime($time));
			case 7200: return date('Y-m-d ',strtotime($time)).(floor(date('H',strtotime($time))/2)*2).':00:00';
			case 86400:return date('Y-m-d',strtotime($time)).' 00:00:00';
		}
	}
	...
	function getCeilTime($time,$duration)
	{
		switch ($duration)
		{
			case 300: return date('Y-m-d H:',strtotime($time)).(ceil(date('i',strtotime($time))/5)*5).':00';
			case 1800: return date('Y-m-d H:',strtotime($time)).(ceil(date('i',strtotime($time))/30)*30).':00';
			case 3600: return date('Y-m-d H:00:00',strtotime('+1 hour',strtotime($time)));
			case 7200: return date('Y-m-d ',strtotime($time)).(ceil(date('H',strtotime($time))/2)*2).':00:00';
			case 86400:return date('Y-m-d',strtotime('+1 day',strtotime($time))).' 00:00:00';
		}
	}
}