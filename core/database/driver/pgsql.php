...
class pgsql extends database
{
	...
	public static function getInstance($config)
	{
		...
		if (! isset(self::$_pgsql[$configKey]) || empty(self::$_pgsql[$configKey]))
		{
			self::$_pgsql[$configKey] = new pgsql($config);
		}
		return self::$_pgsql[$configKey];
	}
