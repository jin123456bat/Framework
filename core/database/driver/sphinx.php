...
use \PDO;
use framework\core\database\sphinx\sql;
...
class sphinx extends database
{
	...
	public static function getInstance($config)
	{
		...
		{
			self::$_mysql[$configKey] = new sphinx($config);
		}
	...
	private function connect($config)
	{
		...
		try{
			$pdo = new PDO('mysql:host=' . $config['server'] . ';port=' . $db_port , $user, $password, array(
